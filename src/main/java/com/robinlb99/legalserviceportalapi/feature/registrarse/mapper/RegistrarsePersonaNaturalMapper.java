...
/**
 * Mapper para el registro de una persona natural.
...
public class RegistrarsePersonaNaturalMapper {
    ...
    /**
     * Convierte un DTO de solicitud de registro de persona natural a una entidad PersonaNatural.
     *
     * @param datosCliente El DTO de solicitud.
     * @return La entidad PersonaNatural.
     * @throws IllegalGeneroException Si el género proporcionado no es válido.
     * @throws IllegalEstadoCivilException Si el estado civil proporcionado no es válido.
     */
    public PersonaNatural cNaturalDtoToCNaturalEntity(
        ...
        Genero genero = switch (datosCliente.genero()) {
            ...
            default -> throw new IllegalGeneroException(
        ...
        EstadoCivil estadoCivil = switch (datosCliente.estadoCivil()) {
            ...
            default -> throw new IllegalEstadoCivilException(
                "El estado civil ingresado no es valido"
            );
        };
        ...
        clienteNatural
            .getDatosPersonales()
            .setApellidos(datosCliente.apellidos());
        clienteNatural
            .getDatosPersonales()
            .setNumero_cedula(datosCliente.numeroCedula());
        clienteNatural
            .getDatosPersonales()
            .setCorreo_electronico(datosCliente.correoElectronico());
        clienteNatural
            .getDatosPersonales()
            .setNumero_telefono(datosCliente.numeroTelefono());
        ...
        clienteNatural.setDireccion_domicilio(
    ...
    /**
     * Convierte una entidad PersonaNatural a un DTO de respuesta de registro de persona natural.
     *
     * @param clienteNatural La entidad PersonaNatural.
     * @return El DTO de respuesta.
     */
    public DatosPersonaNaturalResponseDTO entityToDatosClienteNaturalResponseDTO(
