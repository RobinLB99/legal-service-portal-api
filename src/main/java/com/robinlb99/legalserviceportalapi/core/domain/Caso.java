...
public class Caso implements Serializable {
	...
	public Caso(Long id, String titulo, String descripcion, EstadoCaso estado_caso, LocalDate fecha_creacion,
			TipoCaso tipo_caso, Cliente cliente, Abogado abogado) {
		this.id = id;
		this.titulo = titulo;
